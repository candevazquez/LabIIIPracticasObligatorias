...
// Es obligatorio para este CC resolverlo con la función map()
 ...
 const returnMovieTitle = (watchList) => {
    ...
    return watchList
    .filter((movie) =>movie.Director === "Christopher Nolan" ) //filtro por director
    .filter((movie) => parseFloat(movie.imdbRating) > 8.0 ) //filtro por imdbRating
    .map((movie)=> movie.Title ) //mapeo los titulos
